...
public class TestCreateAd {
    ...
    @Test
    public void testCreateAdWithBadWords() throws IOException {
    ...
    @Test
    public void testCreateAdWithBadTitle() throws IOException {
        AdCreateRequest adCreateRequest = AdUtil.getRandomAdCreateRequest();
    ...
    @Test
    public void testCreateAdWithBadDescription() throws IOException {
        AdCreateRequest adCreateRequest = AdUtil.getRandomAdCreateRequest();
    ...
    @Test
    public void testCreateAdWithBadBidPrice() throws IOException {
        AdCreateRequest adCreateRequest = AdUtil.getRandomAdCreateRequest();
    ...
    @Test
    public void testCreateAdWithBadTotalBudget() throws IOException {
    ...
    @Test
    public void testCreateAdWithBadFrequencyCapping() throws IOException {
        AdCreateRequest adCreateRequest = AdUtil.getRandomAdCreateRequest();
    ...
    @Test
    public void testCreateAdWithBadLocation() throws IOException {
        AdCreateRequest adCreateRequest = AdUtil.getRandomAdCreateRequest();
